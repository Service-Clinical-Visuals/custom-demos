...
export default function Footer() {
  return (
    <footer className="bg-[#005575] text-white pt-8">
      <div className="container mx-auto px-6 lg:px-10 py-5">
            ...
            <div className="flex gap-3 mt-5">
              {[
                ...
                <a
                  key={idx}
                  href="#"
                  className="w-9 h-9 rounded-full bg-[#12B7E5] flex items-center justify-center hover:bg-white hover:text-[#005575] transition"
                >
                  <Icon size={16} />
                </a>
              ))}
        ...
        {/* Bottom Section */}
        <div data-aos="fade-up" data-aos-delay="500" className="flex flex-col md:flex-row justify-between items-center gap-4 text-white/80 text-[14px] sm:text-[15px] md:text-[16px] lg:text-[17px]">
