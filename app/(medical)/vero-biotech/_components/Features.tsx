  ...
  return (
    <section className="py-16 lg:py-28 bg-[#fafafa]">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-12 lg:gap-18 items-center">

          <div data-aos="fade-right">
            <h2 className="font-semibold text-[#111] mb-6 leading-tight">
              Patient Care Is Hard Enough Your iNO Should Be Easy
            </h2>
            <p className="text-muted mb-8 lg:mb-7 leading-relaxed">
            ...
            <div className="space-y-4 sm:space-y-6">
              {[
                ...
                {
                  title: "EFFICIENT",
                  desc: "Designed for fast, hassle-free setup and rapid dose initiation, enabling iNO therapy delivery."
                },
                {
                  title: "COMPATIBLE",
                  desc: "Engineered for flexible integration with a wide range of respiratory devices and adaptable use across multiple care environments."
                }
              ].map((item, i) => (
                <div key={i} className="bg-white border border-gray-200 shadow-sm rounded-3xl p-6 lg:p-8 hover:shadow-md transition-shadow relative overflow-hidden group border-r-4 border-r-[#417586]">
                  ...
                  <p className="text-muted text-[14px] lg:text-[17px] leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>

            {/* <Link href="#" className="inline-flex items-center gap-2 bg-[#122b34] text-white px-8 py-3.5 rounded-sm text-[15px] lg:text-[17px] font-medium hover:bg-primary/90 transition-colors rounded-tl-2xl rounded-br-2xl">
