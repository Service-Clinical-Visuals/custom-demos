  ...
  return (
    <section className="py-16 lg:py-32 bg-[#0e2229] relative overflow-hidden">
      <div className="container relative z-10">
            ...
            <ul className="space-y-4 mb-10">
              {['Advancing patient care through innovative healthcare solutions', 'Driving innovation through science, development, and commercialization', 'Developing advanced technologies for nitric oxide delivery'].map((item, i) => (
                <li key={i} className="flex items-start gap-3 text-gray-300">
                  ...
                  <span className="text-[15px] lg:text-[16px]">{item}</span>
                </li>
              ))}
            </ul>
        ...
        {/* Bottom Banner */}
        <div className="bg-[#386b7b] rounded-3xl lg:rounded-full p-8 lg:px-18 lg:py-14 text-center relative overflow-hidden shadow-2xl" data-aos="fade-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 divide-y md:divide-y-0 md:divide-x divide-white/30 text-left mx-auto border-t border-t-white/30 pt-8">
            <div className="flex items-start gap-4 pt-6 md:pt-0 md:pr-8">
              ...
              <p className="text-white text-[14px] lg:text-[16px] leading-relaxed">Patented Technology Generates Inhaled Nitric Oxide On Demand While Eliminating The Burden Of Tanks.</p>
            </div>
            <div className="flex items-start gap-4 pt-6 md:pt-0 md:pl-8">
              <div className="w-6 h-6 rounded-full border-2 border-white flex items-center justify-center shrink-0 mt-0.5">
                <ArrowRight className="w-3.5 h-3.5 text-white" />
              </div>
              <p className="text-white text-[14px] lg:text-[16px] leading-relaxed">Automatic Cassette Transition Ensures Continuous, Uninterrupted Dosing, And Minimal Device Management Time.</p>
            </div>
          </div>
        </div>
      </div>
