    ...
    <footer className="w-full relative overflow-hidden flex flex-col">
      ...
      <div className="bg-primary pt-16 pb-12 w-full" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          {/* Main Footer Content */}
          <div className="grid grid-cols-1 md:grid-cols-12 gap-5 lg:gap-12">
            ...
            <div className="col-span-1 md:col-span-12 lg:col-span-4 flex flex-col">
              ...
              <div className="flex items-center w-full max-w-sm bg-white p-1">
                <input type="email" placeholder="Please enter email" className="flex-1 bg-transparent px-3 py-2 text-base text-gray-700 outline-none placeholder-gray-400" />
            ...
            {/* Right Side Links */}
            <div className="col-span-1 md:col-span-12 lg:col-start-6 lg:col-span-7 flex flex-col sm:flex-row justify-between gap-y-10 gap-x-6">
              {/* Quick Links Col */}
              <div className="flex flex-col gap-5">
                <h4 className="text-white font-heading font-semibold text-[20px] min-[2560px]:text-3xl ">Quick Links</h4>
                <ul className="flex flex-col gap-4">
                  {['Home', 'Products', 'Technology', 'Patients', 'News'].map((link) => (
                    <li key={link}>
                      <Link href={`#${link.toLowerCase()}`} className="text-white text-[18px] hover:text-gray-200 transition-colors font-normal min-[2560px]:text-2xl">
                        {link}
                      </Link>
                    </li>
                  ))}
              ...
              {/* Contact Col */}
              <div className="flex flex-col gap-5">
                <h4 className="text-white font-heading font-semibold text-[20px] min-[2560px]:text-3xl">Contact</h4>
                <ul className="flex flex-col gap-5">
                  <li className="flex items-start gap-4">
                    <MapPin className="text-white w-5 h-5 shrink-0 mt-0.5" />
                    <span className="text-white text-[18px] leading-relaxed min-[2560px]:text-2xl">
                      ICT Facilities,<br />
                  ...
                  <li className="flex items-center gap-4">
                    ...
                    <a href="tel:+34928652347" className="text-white text-[18px] hover:text-gray-200 transition-colors min-[2560px]:text-2xl">
                      +34 928 652 347
                    </a>
                  </li>
                  <li className="flex items-center gap-4">
                    <Mail className="text-white w-5 h-5 shrink-0" />
                    <a href="mailto:info@osteobionix.com" className="text-white text-[18px] hover:text-gray-200 transition-colors min-[2560px]:text-2xl">
      ...
      <div className="bg-white py-5 border-t border-gray-200 w-full" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="100">
        <div className="container mx-auto px-4 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[16px] font-normal text-primary">
