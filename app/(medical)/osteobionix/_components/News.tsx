        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {newsItems.map((item, index) => (
            ...
            >
              ...
              <span className="text-gray-500 text-xs font-medium min-[2560px]:text-lg">{item.date}</span>
              ...
              <h4 className="text-[#317d71] font-semibold font-heading text-base md:text-lg  min-[2560px]:text-xl">
                {item.title}
              </h4>
            </Link>
          ))}
