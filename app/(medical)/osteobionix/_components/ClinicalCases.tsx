        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {cases.map((c, idx) => (
            <div key={idx} className="bg-white rounded-2xl p-6 lg:p-8 shadow-sm border border-gray-200 flex flex-col" data-aos="fade-up" data-aos-delay={idx * 150}>
              <h4 className="text-[#317d71] font-semibold text-center font-heading text-base md:text-lg  mb-4 min-h-[48px] flex items-center justify-center max-w-[85%] mx-auto">
                {c.title}
              </h4>
