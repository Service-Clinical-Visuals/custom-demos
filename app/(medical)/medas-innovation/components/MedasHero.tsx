...
export default function MedasHero() {
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className="medas-root relative z-10 h-full flex items-center justify-center lg:justify-start px-6 sm:px-10 mt-16 sm:mt-20 lg:mt-30 lg:ml-40 2xl:mt-55">
      ...
      <div className="absolute inset-y-0 left-4 flex items-center">
        <button className="cursor-pointer bg-white/20 hover:bg-white/40 text-white w-11 h-11 lg:w-10 lg:h-10 xl:w-15 xl:h-15 2xl:w-17 2xl:h-17 rounded-md flex items-center justify-center">
          <ArrowLeft size={25} />
        </button>
      </div>
