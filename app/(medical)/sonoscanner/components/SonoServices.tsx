...
const services = [
  {
    ...
    title: "IMAGE QUALITY",
    description:
      "Sonoscanner ultrasound systems deliver exceptional Full HD image quality, providing clear and detailed visualization for enhanced diagnostic confidence.",
  },
  {
    icon: "/sono-scanner/sono-service-2.png",
    title: "PORTABILITY",
    description:
      "Our ultrasound systems are designed for maximum mobility and convenience, making them easy to carry and ready to use whenever and wherever needed.",
  },
  {
    icon: "/sono-scanner/sono-service-3.png",
    title: "ERGONOMICS",
    description:
      "Designed with healthcare professionals in mind, Sonoscanner ultrasound systems offer an intuitive and user-friendly experience that simplifies workflows.",
  },
  {
...
export default function SonoServices() {
  ...
  return (
    <section className="relative bg-[#f5f5f5] py-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-8 lg:px-14">
        {/* HEADING */}
        <div className="text-center">
          <div data-aos="fade-up">
            <h2 className="text-[#123f88] text-4xl leading-none font-semibold tracking-[-2px]">
              Our Services
            </h2>
          </div>

          <div data-aos="fade-up" data-aos-delay="120">
            <p className="mt-7 max-w-[950px] mx-auto text-[#707070] text-[16px] leading-[1.9]">
                  ...
                  .map((service, index) => (
                    ...
                    >
                      ...
                      <div className="absolute left-1/2 -translate-x-1/2 -top-[52px] z-20">
                        <div className="w-[110px] h-[110px] rounded-full bg-[#123f88] shadow-[0_10px_30px_rgba(0,0,0,0.12)] border-[10px] border-[#f5f5f5] flex items-center justify-center">
                      ...
                      {/* CARD */}
                      <div className="bg-white rounded-[28px] pt-24 pb-14 px-10 shadow-[0_10px_25px_rgba(0,0,0,0.06)] border border-[#ececec] text-center transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_18px_40px_rgba(0,0,0,0.08)]">
                        {/* TITLE */}
                        <h3 className="text-[#123f88] text-[28px] font-semibold tracking-[-0.5px]">
                          {service.title}
                        </h3>

                        {/* DIVIDER */}
                        <div className="w-full h-[1px] bg-[#d8dfeb] mt-7 mb-7" />

                        {/* DESCRIPTION */}
                        <p className="text-[#707070] text-[16px] leading-[2]  mx-auto">
                          {service.description}
                        </p>
                      </div>
                    </div>
