        ...
        <div className="max-w-[1600px] w-full mx-auto px-10 pb-28">
          <div className="max-w-[775px]">
            ...
            <div data-aos="fade-up" data-aos-delay="150">
              <p className="mt-7 text-white/80 text-xl font-light">
                A full range of outstanding performance ultrasounds
              </p>
            </div>

            <div data-aos="fade-up" data-aos-delay="300">
              <button className="mt-10 bg-white text-[#1b3e84] hover:bg-[#f5f5f5] transition-all duration-300 rounded-full h-[56px] px-8 flex items-center gap-4 text-[14px] font-semibold shadow-xl">
                Discover Technology
