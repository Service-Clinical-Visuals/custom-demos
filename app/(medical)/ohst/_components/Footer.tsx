  ...
  return (
    <footer className="bg-[#099F94] pt-16 pb-8 font-outfit text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-10">
        ...
        {/* Top 4-Column Layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[4fr_2fr_2fr_3.5fr] gap-8 lg:gap-12 xl:gap-16 mb-12">
          ...
          <div className="flex flex-col items-start">
            ...
            <Typography variant="body-sm" color="text-white/80" className="mb-6 pr-4 leading-relaxed text-[14px]">
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="w-8 h-8 rounded-[8px] bg-white text-[#099F94] hover:bg-white/90 transition-all flex items-center justify-center shadow-sm"
                aria-label="Linkedin"
              >
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="flex flex-col gap-4">
              {["Home", "Services", "Products", "Patients", "User", "About OHST", "Career", "Contact"].map((item) => (
                <li key={item}>
                  <Link href="#" className="text-white/80 hover:text-white transition-colors text-[14px] leading-relaxed">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="flex flex-col gap-4 text-white/80 text-[14px] leading-relaxed">
          ...
          <div className="flex flex-col items-start">
            ...
            <Typography variant="body-sm" color="text-white/80" className="mb-6 leading-relaxed text-[14px]">
        ...
        {/* Copyright */}
        <div className="text-center text-white/60 text-[14px]">
