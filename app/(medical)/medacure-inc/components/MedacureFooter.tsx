...
export default function MedacureFooter() {
  ...
  return (
    <footer className="bg-[#2e2463] relative pt-56 md:pt-38 mt-20" id="contact">
      ...
      {/* FLOATING CTA */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-300  2xl:max-w-[80%] px-6">
        <div
          data-aos="fade-up"
        ...
        >
          {/* Text */}
          <div className="text-white max-w-md 2xl:max-w-[80%] text-center md:text-left">
            <h3 className="text-xl md:text-2xl font-semibold mb-2">
              Ready to learn More?
            </h3>
            <p className="text-white/80 text-base 2xl:max-w-[80%]">
