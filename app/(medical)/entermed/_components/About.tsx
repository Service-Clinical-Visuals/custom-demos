      ...
      <div className="container mx-auto px-4 lg:px-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 mb-10 lg:mb-14 items-center">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl md:text-[32px] font-semibold text-[#F5333F] mb-4 flex items-center gap-3">
              <span className="text-[#F5333F] text-2xl leading-none pb-1">&bull;</span> About Us
            </h2>
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="rounded-[20px] border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.04)] aspect-square bg-white flex items-center justify-center p-6 relative overflow-hidden">
