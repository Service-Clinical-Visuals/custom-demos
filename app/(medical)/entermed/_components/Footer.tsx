...
export default function Footer() {
  return (
    <footer className="bg-[#FCF9F9] pt-16 pb-8 border-t border-gray-100">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-gray-500 text-[14.5px] leading-[1.7] mb-8 pr-4">
            ...
            <div className="flex items-center gap-3">
              <input 
                ...
                className="bg-white border border-primary/50 focus:border-primary rounded-[6px] px-4 py-2.5 text-[14px] outline-none w-full shadow-sm"
              />
          ...
          <div className="flex flex-col lg:pl-20">
            <h4 className="text-primary font-bold text-[16px] mb-6">Quick Links</h4>
          ...
          <div className="flex flex-col">
            <h4 className="text-primary font-bold text-[16px] mb-6">Our Technology</h4>
            <div className="flex flex-col gap-3.5">
          ...
          {/* Column 4: Contact */}
          <div className="flex flex-col">
            <h4 className="text-primary font-bold text-[16px] mb-6">Contact</h4>
            <div className="flex flex-col gap-5">
              <div className="flex items-start gap-3">
                <MapPin className="text-primary w-5 h-5 flex-shrink-0 mt-0.5" strokeWidth={1.5} />
                <span className="text-gray-600 text-[14.5px] leading-[1.6]">
                  Steenovenweg 4 3417 XR<br/>Montfoort , The<br/>Netherlands
                </span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="text-primary w-5 h-5 flex-shrink-0" strokeWidth={1.5} />
                <span className="text-gray-600 text-[14.5px]">+31 (0) 30 72 00 880</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="text-primary w-5 h-5 flex-shrink-0" strokeWidth={1.5} />
        ...
        <div className="pt-8 border-t border-gray-300 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap items-center gap-x-8 gap-y-3">
            <Link href="#" className="text-gray-500 hover:text-primary text-[13px] transition-colors">Privacy Settings</Link>
            <Link href="#" className="text-gray-500 hover:text-primary text-[13px] transition-colors">Privacy Statement</Link>
            <Link href="#" className="text-gray-500 hover:text-primary text-[13px] transition-colors">Terms and Conditions</Link>
          </div>
        </div>
