        ...
        <div className="bg-primary text-white text-sm">
            <div className="site-container flex flex-col sm:flex-row justify-between items-stretch h-auto sm:h-[42px] text-[12px] font-medium tracking-wide">
                ...
                <div className="flex bg-primary-dark self-stretch items-center text-[11px] font-bold uppercase tracking-wider">
                    <a href="#" className="flex items-center px-8 h-full hover:bg-black/10 transition-colors border-x border-white/20 bg-primary/30">
                        Book your Appointment
                    </a>
                    <a href="#" className="flex items-center px-8 h-full hover:bg-black/10 transition-colors border-r border-white/20">
                        Online request
                    </a>
                </div>
            </div>
