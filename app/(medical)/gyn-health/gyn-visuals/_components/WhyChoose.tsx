...
export default function WhyChoose({ whyChoose }: WhyChooseProps) {
    ...
    return (
        <>
            ...
            >
                <SectionTitle
                    title="Why Doctors Choose GYN-Health Visuals"
                ...
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12 mt-15 px-4">
                    <div className="relative group overflow-hidden" data-aos="fade-right">
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col items-center text-center h-full hover:shadow-xl transition-shadow duration-300 relative overflow-hidden">
                            ...
                            <p className="text-gray-600 leading-relaxed font-medium relative z-10">Turn confusion into clarity with GYN-Health Visuals. Our 3D animations make conditions easy to understand, helping patients feel confident and loyal to your practice.</p>
                        </div>
                    </div>
                    ...
                    <div className="relative group overflow-hidden" data-aos="fade-left">
                        <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col items-center text-center h-full hover:shadow-xl transition-shadow duration-300 relative overflow-hidden">
                            ...
                            <p className="text-gray-600 leading-relaxed font-medium relative z-10">Why stop at the clinic? With GYN-Health Visuals, you can share animations across websites, social media, emails, and patient portals—strengthening your reputation and digital reach.</p>
                        </div>
                    </div>
                </div>
            </section>
