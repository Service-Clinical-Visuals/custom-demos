      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-[40%_60%] gap-12 items-start">
          ...
          <div className=" bg-white p-8 rounded-2xl border border-gray-100 shadow-sm sticky top-24">
            <h3 className="text-primary font-bold mb-3 text-[16px] uppercase tracking-wider">Latest Updates & Innovations</h3>
          ...
          <div className=" flex flex-col gap-4">
            {updates.map((update, idx) => (
              <div key={idx} className="bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-sm hover:border-primary/30 transition-colors">
