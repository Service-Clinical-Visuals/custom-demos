    ...
    >
      ...
      <div className="container relative z-10">
        <div className="text-center flex flex-col">
          <h3 data-aos="fade-up" className="font-bold mb-3 text-[16px] uppercase tracking-widest text-white/80">Latest Products</h3>
          ...
          <p data-aos="fade-up" data-aos-delay="200" className="text-[16px] text-white/90 mb-12 max-w-5xl mx-auto leading-[1.7] px-4">
