    ...
    <section className="w-full py-16 md:py-24 bg-white relative">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Image Placeholder */}
          <div className="w-full h-[350px] md:h-[450px] bg-gray-100 rounded-2xl overflow-hidden relative shadow-sm flex items-center justify-center">
            <img src="/sunset-healthcare/home/about.jpg" alt="About" className="w-full h-full object-cover" />
          </div>

          {/* Content */}
          <div>
            <h3 className="text-primary font-bold mb-3 flex items-center gap-2 text-[16px]">
              About Us
            </h3>
            ...
            <div className="space-y-4 text-muted text-justify text-[18px] leading-[1.7] mb-8">
              <p>
