      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col">
            ...
            <div data-aos="fade-up" data-aos-delay="100" className="space-y-4 text-[18px] text-justify leading-[1.7] text-white/90 mb-8">
              <p>
            ...
            <ul className="space-y-4 mb-8">
              {points.map((point, idx) => (
                <li key={idx} data-aos="fade-up" data-aos-delay={300 + (idx * 100)} className="flex gap-3 text-[18px] text-white">
