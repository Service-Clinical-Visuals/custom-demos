...
export default function CommaFooter() {
  return (
    <footer className="relative bg-[#1B1212] overflow-hidden"> 
      <div className="relative z-10 mx-auto max-w-[1550px] px-10 pt-14 pb-6">

        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1.4fr_1.2fr_1.2fr]">
          ...
          <div data-aos="fade-up">
            ...
            <p className="mt-5 text-[13px] leading-7 text-white">
          ...
          <div data-aos="fade-up" data-aos-delay="80">
            <h4 className="text-[14px] font-bold uppercase tracking-wider text-white">Quick Links</h4>
            <ul className="mt-5 space-y-3">
              {quickLinks.map((l) => (
                <li key={l}>
                  <a href="#" className="text-[13px] text-white transition hover:text-[#FF4A43]">{l}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div data-aos="fade-up" data-aos-delay="160">
            <h4 className="text-[14px] font-bold uppercase tracking-wider text-white">Contact</h4>
            <div className="mt-5 space-y-4">
              <div className="flex items-start gap-2">
                <Phone size={14} className="mt-0.5 shrink-0 text-[white]" />
                <span className="text-[13px] text-white">+44 (0) 1474 564 311</span>
              </div>
              <div className="flex items-start gap-2">
                <Phone size={14} className="mt-0.5 shrink-0 text-[transparent]" />
                <span className="text-[13px] text-white">+44 (0) 1474 564 322</span>
              </div>
              <div className="flex items-start gap-2">
                <Mail size={14} className="mt-0.5 shrink-0 text-[white]" />
                <span className="text-[13px] text-white">Millers Lubricants Limited,<br />Dening Way, Gravesend, Kent<br />DA12 2QZ, UK</span>
              </div>
            </div>
          </div>
          ...
          <div data-aos="fade-up" data-aos-delay="240">
            <h4 className="text-[14px] font-bold uppercase tracking-wider text-white">Legal &amp; Privacy</h4>
            <ul className="mt-5 space-y-3">
              {legalLinks.map((l) => (
                <li key={l}>
                  <a href="#" className="text-[13px] text-white transition hover:text-[#FF4A43]">{l}</a>
          ...
          <div data-aos="fade-up" data-aos-delay="320">
            <h4 className="text-[14px] font-bold uppercase tracking-wider text-white">Policies &amp; Standards</h4>
            <ul className="mt-5 space-y-3">
              {policyLinks.map((l) => (
                <li key={l}>
                  <a href="#" className="text-[13px] text-white transition hover:text-[#FF4A43]">{l}</a>
      ...
      {/* Bottom bar */}
      <div className="relative mt-24 z-20 border-t border-white/20 bg-[#1B1212] w-screen h-20 items-center flex justify-between px-10">
        <p className="text-[12px] text-white">
          Copyright © 2024 Millers Lubricants Limited. All rights reserved.
        </p>
