...
const Button = ({
  ...
  const baseStyles = "relative inline-flex items-center justify-center font-bebas uppercase tracking-wider transition-all duration-300 active:scale-95 select-none cursor-pointer";
  ...
  if (variant === "primary") {
    ...
    innerSkewClass = "bg-primary group-hover:bg-primary-hover transform -skew-x-[25deg]";
  } else if (variant === "outline") {
    // Slanted outline button
    variantStyles = "text-white py-2 px-6 md:py-2.5 md:px-8 text-[16px] md:text-[18px] hover:text-primary";
    innerSkewClass = "border border-white hover:bg-white transform -skew-x-[25deg]";
