    ...
    <footer className="w-full bg-[#031128] pt-12 pb-0 border-t border-white/5">
      <div className="custom-container p-4 md:p-6 xl:px-35 ">
        ...
        <div className="flex flex-col lg:flex-row justify-between mb-12" data-aos="fade-up">
          ...
          <div className="w-full lg:w-auto flex-1 flex flex-col sm:flex-row justify-end xl:gap-2">
            ...
            <div className="w-full sm:w-auto mb-10 sm:mb-0">
              ...
              <ul className="space-y-4">
                ...
                <li><p className="text-transparent [-webkit-text-stroke:1px_white] text-[15px] !font-(family-name:--font-dm-sans) font-semibold italic leading-relaxed">See All ...</p></li>
              </ul>
            </div>
        ...
        {/* Socials & Newsletter */}
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center  border-t border-white/5 " data-aos="fade-up">
          ...
          <div className="mb-8 lg:mb-0">
            ...
            <div className="flex space-x-5">
              {/* TikTok */}
              <Link href="#" className="text-white hover:text-[#00d2ff] transition-colors">
      ...
      <div className="bg-[#081b37] py-4" data-aos="fade-up">
        <div className="custom-container px-4 md:px-6 xl:px-35 flex flex-col md:flex-row justify-between items-center">
