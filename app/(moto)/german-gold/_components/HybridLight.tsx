...
export default function HybridLight() {
  return (
    <section id="hybrid-light" className="relative w-full py-10 lg:py-8 bg-white overflow-hidden">
      <Container>
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">

          {/* Left Content - Video 01 Placeholder */}
          <div className="w-full aspect-[16/10] rounded flex items-center justify-center overflow-hidden relative order-2 lg:order-none" data-aos="fade-left">
          ...
          {/* Right Content */}
          <div className="contents lg:flex lg:flex-col lg:space-y-6">
            <div className="mb-2 order-1 lg:order-none w-full" data-aos="fade-right">
            ...
            <div className="space-y-4 text-[#6E777D] mt-2 order-3 lg:order-none w-full max-w-[92%]" data-aos="fade-right" data-aos-delay="100">
            ...
            <div className="pt-2 lg:pt-4 order-4 lg:order-none w-full" data-aos="fade-right" data-aos-delay="200">
