  ...
  return (
    <section className="py-14 lg:py-16 bg-white flex justify-center w-full">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-10 max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          {sites.map((site, index) => (
            ...
            >
              ...
              <h4 className="text-center font-bold text-base lg:text-lg text-[#1B1537] font-oxanium uppercase pb-2 tracking-wide mb-1">
                {site.title}
              </h4>
