    ...
    return (
        <>
            <section style={{ backgroundImage: `url('${cdn}/client/img/liger-visuals/offers-bg.webp')` }} className={`w-full py-20 overflow-hidden relative bg-cover bg-no-repeat`}>
                <div className="absolute inset-0 pointer-events-none bg-[linear-gradient(180.7deg,#785f9a99_0.65%,#9b8ab26e_99.45%)]"></div>
                <div className="relative">
                    <SectionTitle
                        title="What We Offer You"
                        className="text-white"
                    />
                    <hr className="w-[10%] mt-3 mx-auto border-3 border-[#d8fbd8] rounded-lg" />
                    <div className="container mx-auto grid grid-cols-1 mt-12 justify-items-center">
                        <div className="w-full lg:w-2/3 bg-[#82689ea3] text-white p-5 md:p-10 rounded-2xl backdrop-blur-md" data-aos="fade-up" data-aos-delay={200}>
                            <div>
                                <h4 className="text-3xl font-semibold mb-4">GYN-Health Visuals Library</h4>
                                <p className="mb-6 text-justify">Enjoy 30-days free access to the GYN-Health Visuals library of explainer animations. View & share unlimited animations with your patients & colleagues by email & SMS. At the conclusion of your 30-day free trial, you will automatically become a monthly subscriber and enjoy ongoing access to our ever-expanding library of videos.</p>
                            </div>
                            <div>
                                <ul>
