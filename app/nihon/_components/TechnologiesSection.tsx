...
const TechnologiesSection = () => {
  return (
    <section className="py-24 bg-[#D8EFFF]">
          ...
          {technologies.map((tech, index) => (
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg bg-white mb-6 aspect-[4/3]">
                {/* Logo Badge */}
                <div className="absolute top-4 left-4 z-20 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100 min-w-[100px] flex items-center justify-center">
                  <img
                    src={tech.logo}
                    alt={tech.title}
                    className="w-16 h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  />
                </div>
