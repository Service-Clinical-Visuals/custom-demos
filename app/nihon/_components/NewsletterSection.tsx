...
const NewsletterSection = () => {
  return (
    <section className="py-24 bg-[url('/nihon/images/subscribe-bg.png')] bg-center bg-cover relative overflow-hidden text-white">
      ...
      <div className="container mx-auto px-4 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h3 className="text-[24px] md:text-[28px] font-bold text-white mb-8 leading-tight max-w-xl">
              Subscribe to stay updated on Nihon Kohden's latest healthcare innovations.
            </h3>
