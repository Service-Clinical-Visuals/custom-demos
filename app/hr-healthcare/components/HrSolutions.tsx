...
const cards = [
  {
    icon: "/hr-healthcare/hr-solution-1.png",
    title: "Our Purpose",
    description:
  ...
  {
    icon: "/hr-healthcare/hr-solution-2.png",
    ...
    <section className="relative overflow-hidden bg-[#031B35] py-20">
      ...
      <div className="relative z-10 mx-auto max-w-380 px-6">
        ...
        <div className="grid items-start gap-10 lg:grid-cols-2">
          ...
          >
            <img
              src="/hr-healthcare/hr-solution.png"
              alt="Healthcare Team"
