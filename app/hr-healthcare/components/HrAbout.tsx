...
const cards = [
  {
    ...
    icon: "/hr-healthcare/hr-about-1.png",
    description:
  ...
  },
  {
    ...
    icon: "/hr-healthcare/hr-about-2.png",
    description:
  ...
  },
  {
    ...
    icon: "/hr-healthcare/hr-about-3.png",
  ...
  return (
    <section className="relative overflow-hidden bg-[#F5F5F5] py-12 md:py-16 lg:py-20">
      ...
      <div className="mx-auto max-w-380 px-4 sm:px-6">
        <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 md:gap-5 lg:grid-cols-3">
          {cards.map((card, index) => {
            ...
            return (
              ...
              >
                ...
                {/* CONTENT */}
                <div className="flex flex-1 flex-col px-5 pb-7 pt-5 text-center sm:px-8 sm:pb-8">
                  {/* ICON */}
                  <div
